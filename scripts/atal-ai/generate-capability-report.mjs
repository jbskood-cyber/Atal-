...
const lines = [
  ...
  `- Approved in-scope capabilities: **${summary.approvedTotal}**`,
  `- Covered: **${summary.covered}**`,
  `- Partial: **${summary.partial}**`,
  `- Missing: **${summary.missing}**`,
  `- Deliberately excluded: **${summary.excluded}**`,
  `- Total matrix coverage, including exclusions: **${summary.parityPercent}%**`,
  `- Approved agentic parity: **${summary.approvedParityPercent}%**`,
  '',
