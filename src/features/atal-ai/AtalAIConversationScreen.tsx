...
export function AtalAIConversationScreen() {
  ...
  return <main className="atal-command-page">
    ...
    <section className="atal-command-thread" aria-live="polite">
      {!conversation.messages.length&&<article className="atal-command-intro"><AtalMark/><div><b>Atal IA</b><p>Cuéntame qué necesitas. Puedo consultar Atal o preparar cambios para que los revises antes de aplicarlos.</p></div></article>}
