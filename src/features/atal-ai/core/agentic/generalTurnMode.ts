...
const workspaceReadPatterns = [
  /\b(?:qué|que)\s+(?:pacientes|planes|ejercicios|sesiones|reportes|expedientes)\b.{0,72}\b(?:tengo|tienes|tenemos|hay|existen|registrad[oa]s?|guardad[oa]s?|activ[oa]s?|recientes?)\b/i,
